...
Hotkey, F5, Hideout
;Hotkey, NumpadEnd, Synthesis
;Hotkey, NumpadDown, Delve
;Hotkey, NumpadPgdn, Remaining
;Hotkey, NumpadRight, ASec
Hotkey, F4, SyncMe
...
Delve:
SendInput, {Enter}/delve{Enter}
return

Synthesis:
SendInput, {Enter}/synthesis{Enter}
return
